...
export const Navbar = () => {
  return (
    <Container    boxShadow="lg" maxW="full" w="full" bg="#f0f1f7" border="1px solid black">
      <Box maxW="full" w="full">
      <Box maxW="full" w="full" > 
      <Text maxW="full" w="full" bg="#202340" color="white">
        ...
        <Container maxW="6xl">
          ...
          >
            <Grid templateColumns="repeat(2, 1fr)" gap={2}>
              <Box h="5">
                <Select w="210px" border="none" placeholder="All Departments">
