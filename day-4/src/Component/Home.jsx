...
import { NewForm } from '../slides/NewFrom'
import { LayerdForm } from '../slides/Layerdfall'
import { Getfit } from '../slides/Getfit'
import { BestDeals } from '../slides/Bestdeal'
import { Stayhealty } from '../slides/Stayhealty'
import { TopSeller } from '../slides/Topseller'
...
<Container m="auto" gap="20px"  maxW="full" mt="20px" display="flex" > 
      ...
      <Box
        ...
        <Image  src="https://www.shop.com/feo-cdn/G/d/_3Zg_0LDg.webp" />
      <Box p='6'>
        <Box display='flex' alignItems='baseline'>
          <Badge borderRadius='full' px='2' color="#202340">
          2%  Cashback
    ...
    <Box maxW='sm' borderWidth='1px' boxShadow="lg" borderRadius='lg' overflow='hidden'>
      <Box
        ...
        <Image src="https://www.shop.com/feo-cdn/5/A/MrRfTBFSk.webp" />
      <Box p='6'>
        <Box display='flex' alignItems='baseline'>
          <Badge borderRadius='full' px='2' color="#202340" >
          2% Cashback
    ...
    <Box maxW='sm' borderWidth='1px' boxShadow="lg" borderRadius='lg' overflow='hidden'>
      <Box
        ...
        <Image src="https://www.shop.com/feo-cdn/n/G/lJ8iPkWNg.jpg" />
      <Box p='6'>
        <Box display='flex' alignItems='baseline'>
          <Badge borderRadius='full' px='2' color="#202340">
          2% Cashback
    ...
    <Box maxW='sm' borderWidth='1px' boxShadow="lg" borderRadius='lg' overflow='hidden'>
      <Box
        ...
        <Image src="https://www.shop.com/feo-cdn/T/4/hyWd0Cnmc.webp" />
      <Box p='6'>
        <Box display='flex' alignItems='baseline'>
          <Badge borderRadius='full' px='2' color="#202340" >
          2% Cashback
